# Agent guidance for python-single

This repository is managed by projectctl. The contract at
...
- Never bypass the verification ladder: run `projectctl check` before
  declaring work done.
